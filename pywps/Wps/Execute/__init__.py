...
class Execute(Request):
    ...
    def __init__(self,wps, processes=None, spawned=False):
       ...
       #check storeExecuteResponse agains asReference=true
        ...
        if self.storeRequired and self.statusRequired:
            ...
            # save the WPS object to the file
    ...
    def initJob(self, isAsync):
        ...
        self.job = self.process.createJob()
        if not self.job.Initial(self.wps.method, str(self.wps.inputs), isAsync) == 'INITIALED':
    ...
    def executeProcess(self):
        ...
        try:
            ...
            while self.job.status == 'EXECUTING':
                pass
