...
class ComplexInput(Input):
    ...
    def downloadData(self, url):
        ...
        TODO: fix, can't know where the download data is right, as, when the url is a WCS or other 
            ogc service, and the return is exception as xml, this will be continue process with this
            error 
        """
